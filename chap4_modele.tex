...
\toprule
Rang & Score F1 (Positif) & Rappel (Positif) & Précision (Positif) & Couche enrichie & Réseau d’encodage & Métadonnées utilisées              & Dimension de l’encodage & Couche Décisionnelle \\ \midrule
1    & 86.05\%            & 87.25\%          & 84.88\%             & Linéaire        & HAN               & Toutes                             & 128                     & Linéaire             \\
2    & 84.45\%            & 80.08\%          & 89.33\%             & Linéaire        & HAN               & Toutes                             & 128                     & Linéaire             \\
3    & 84.15\%            & 88.84\%          & 79.93\%             & Linéaire        & HAN               & Toutes                             & 256                     & Linéaire             \\
4    & 84.12\%            & 81.27\%          & 87.18\%             & Linéaire        & HAN               & Forme,Siècle,Structure de Citation & 128                     & Linéaire             \\
5    & 83.79\%            & 79.28\%          & 88.84\%             & Linéaire        & HAN               & Forme,Siècle,Structure de Citation & 256                     & Linéaire             \\
6    & 83.30\%            & 78.49\%          & 88.74\%             & LSTM            & LSTM              & Toutes                             & 128                     & Linéaire             \\
7    & 83.17\%            & 83.67\%          & 82.68\%             & Linéaire        & HAN               & Forme,Siècle,Structure de Citation & 128                     & Linéaire             \\
8    & 82.08\%            & 78.49\%          & 86.03\%             & Linéaire        & HAN               & Forme,Siècle,Structure de Citation & 256                     & Linéaire             \\
9    & 81.82\%            & 78.88\%          & 84.98\%             & Linéaire        & HAN               & Toutes                             & 256                     & Linéaire             \\
10   & 81.65\%            & 78.88\%          & 84.62\%             & LSTM            & LSTM              & Forme,Siècle,Structure de Citation & 256                     & Linéaire             \\
11   & 81.24\%            & 78.49\%          & 84.19\%             & LSTM            & LSTM              & Forme,Siècle,Structure de Citation & 128                     & Linéaire             \\
12   & 81.08\%            & 77.69\%          & 84.78\%             & LSTM            & LSTM              & Forme,Siècle                       & 256                     & Linéaire             \\
     & …                  &                  &                     &                 &                   &                                    &                         &                      \\
23   & 78.54\%            & 72.91\%          & 85.12\%             & Aucune          &                   & Aucune                             & 128                     & Linéaire             \\ \bottomrule
\end{tabular}%
}
...
Faut-il en conclure que les métadonnées ne doivent pas être inclues ? Rien n'est moins sûr. Si l'on prend les données bien annotées, et bah, les résultats avec juste forme et siècle sont logiques. Un peu haut, mais logique. Cela laisse dubitatif sur la multiplication liée à 1er siècle / -1er mais bon.

% Mais les catégorie Auteur et Structure logique de citation provoquent en fait un sur-apprentissage.

% MAIS c'est du sur-apprentissage: si on applique le modèle en mode prédiction, on se rend compte que TOUT Martial est tagué en positif, même quand il dit bonjour.
