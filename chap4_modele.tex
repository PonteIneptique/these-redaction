...
\begin{figure}[ht]
    \centering
    \includegraphics{figures/chap4/scoreMetadata.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics{figures/chap4/scoreDispersionEmbeddings.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics{figures/chap4/BertPoolingDetailed.png}
...
D'après les résultats préliminaires, les modèles présentant les meilleurs résultats sont les modèles:
\begin{itemize}
    ...
    \item utilisant un LSTM enrichi ou un réseau à Attention (HAN).
\end{itemize}
Des modèles à réseaux convolutionnels (CNN) et GRU ont été testés mais ne présentaient pas d'améliorations ou de détériorations significatives.
