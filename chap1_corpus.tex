...
\section{Constitution, sources du corpus}
\label{sec:corpus_constitution}

\section{Répartition chronologique du corpus}
\label{sec:corpus_chrono}
...
\section{Statistiques lexicales du corpus}
