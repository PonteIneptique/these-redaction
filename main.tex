...
\defbibheading{subbibliography}[\refname]{\subsection*{#1}\addcontentsline{toc}{subsection}{#1}}
\defbibheading{bibliography}[\refname]{\section*{#1}\addcontentsline{toc}{section}{#1}}
