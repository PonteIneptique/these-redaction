...
Le LASLA a fait le choix d'un étiquettage en partie morphio-syntaxiques. Par exemple, il crée les genres Commun, Masculin-Féminin, Masculin-Neutre. Cet élément aura nécessairement des implications sur la capacité d'un modèle d'inférer le genre d'un mot. Par ailleurs, le genre n'est annoté que sur les éléments hors substantifs (adjectifs, participes principalement). 
